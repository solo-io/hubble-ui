...
func newBytesValue(b []byte) *commonV1.AnyValue {
	return &commonV1.AnyValue{
...
func toList(
	labelsAsMaps, headersAsMaps bool,
	fd protoreflect.FieldDescriptor,
	v protoreflect.Value,
	mb mapBuilder,
	newLeafKeyPrefix string,
) *commonV1.ArrayValue {
	items := v.List()
...
func listToMap(
	v protoreflect.Value,
	converter func(v protoreflect.Value) (string, *commonV1.AnyValue, error),
) *commonV1.AnyValue {
	items := v.List()
...
func newValue(
	assumeList, labelsAsMaps, headersAsMaps bool,
	fd protoreflect.FieldDescriptor,
	v protoreflect.Value,
	mb mapBuilder,
	newLeafKeyPrefix string,
