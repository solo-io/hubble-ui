...
require (
	...
	github.com/solo-io/gloo-otelcollector-contrib/exporter/redisstreamexporter v0.89.0
	github.com/solo-io/gloo-otelcollector-contrib/receiver/hubblereceiver v0.89.0
